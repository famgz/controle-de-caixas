...
$warning_c_icon = "<i class='fa-solid fa-circle-info action-icon text-warning'></i>";
...
$trash_icon = "<i class='fa-solid fa-trash-can action-icon icon-delete text-danger'></i>";
